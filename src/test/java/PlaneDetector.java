...
public class PlaneDetector {
    ...
    public Mat detect(Mat inputFrame,Double frameID) throws Exception{
        ...
        HttpPost request= new HttpPost ("http://192.168.1.3:9763/endpoints/VideoReciever");
...
//        System.loadLibrary("httpcliennt-4.5.2");
        Imshow imshow = new Imshow ("Plane Detection");
        PlaneDetector planeDetector = new PlaneDetector ();
        Mat video_image = new Mat ();
        //Load video file
        VideoCapture videoCapture= new VideoCapture ("/home/anusha/WSO2/Git/OpenCV_PlaneDetection/resources/videos/D1.mp4");
//        VideoCapture videoCapture=new VideoCapture(0);
        ...
        if (videoCapture.isOpened ()){
            while (true){
                ...
                boolean temp = video_image.empty();
...
//                System.out.println(videoCapture.get (1));
            ...
            System.err.println("Video is not available");
        }
        //close video capture
